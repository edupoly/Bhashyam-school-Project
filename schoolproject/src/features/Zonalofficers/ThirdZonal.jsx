...
function ThirdZonal() {
  ...
  useEffect(()=>{
    if(data){
      var fil = data.filter( f => f.branch === 'Pragathi Nagar' || f.branch === 'New Bowenpally' || f.branch === 'Vanasthalipuram');
      setSelBranch(fil);
    }
  },[data])
  return (
    <div>
      <h4 className='text-center my-4'>THIRD ZONAL OFFICER</h4>
      <div>
